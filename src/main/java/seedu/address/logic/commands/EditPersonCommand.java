...
public class EditPersonCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (!personToEdit.isMatchingEmail(editedPerson) && model.hasExistingEmail(editedPerson)) {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        List<Assignment> assignmentList = personToEdit.getAssignments().asUnmodifiableObservableList();
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, email, module, tags);
        }
