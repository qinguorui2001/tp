...
public class EditPersonCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_MODULE_DESC, Module.MESSAGE_CONSTRAINTS); // invalid address
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + MODULE_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + MODULE_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + MODULE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + MODULE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder()
                .withEmail(VALID_EMAIL_BOB).withModule(VALID_MODULE_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        EditPersonCommand expectedCommand = new EditPersonCommand(targetIndex, descriptor);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + INVALID_MODULE_DESC + VALID_MODULE_BOB;
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withModule(VALID_MODULE_BOB).build();
        EditPersonCommand expectedCommand = new EditPersonCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // other valid values specified
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_MODULE_DESC + MODULE_DESC_BOB;
